...
<link rel="stylesheet"
	...
	<link type="text/css" rel="stylesheet" href="total_list.css" />
...
<%
int postsPerPage = 10;
int currentPage = 1; // 현재 페이지 번호 (초기값)
		...
		<section class="noticepart">
			...
			<section class="sc1">
                ...
                try {
                    ...
                    // 게시물 조회
                    String query = "SELECT post_id, title, author, ctime FROM jdbc_test ORDER BY post_id DESC " +
               "LIMIT ? OFFSET ?";
pstmt = connection.prepareStatement(query);
pstmt.setInt(1, postsPerPage);
pstmt.setInt(2, (currentPage - 1) * postsPerPage);
ResultSet resultSet = pstmt.executeQuery();
            ...
            %>	
            		...
            		<ul>
                        <li>
                            <span><input type="checkbox" id ="cb" name="selectedPosts" value="<%=postId%>"></span>
