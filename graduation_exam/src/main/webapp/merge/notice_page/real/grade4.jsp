...
<link rel="stylesheet"
	href="http://netdna.bootstrapcdn.com/font-awesome/4.6.2/css/font-awesome.min.css">
	 <link type="text/css" rel="stylesheet" href="css/grade4.css" />
		...
		<section class="noticepart">
			...
			<section class="sc1">
                ...
                try {
                    ...
                    // 게시물 조회
                    String query = "SELECT post_id, title, author, ctime, grade4 FROM jdbc_test WHERE grade4 = '4학년' ORDER BY post_id DESC";
