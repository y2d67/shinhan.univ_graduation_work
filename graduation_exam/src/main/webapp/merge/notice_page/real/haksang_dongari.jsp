...
<head>
<meta charset="utf-8">
<title>학생회/동아리 게시판</title>
<link rel="stylesheet"
	href="http://netdna.bootstrapcdn.com/font-awesome/4.6.2/css/font-awesome.min.css">
	<link type="text/css" rel="stylesheet" href="css/haksang_dongari.css" />
		...
		<section class="noticepart">
			...
			<section class="sc1">
                ...
                try {
                    ...
                    // 게시물 조회
                    String query = "SELECT post_id, title, author, ctime, tag FROM jdbc_test WHERE tag ='학생회, 동아리' ORDER BY post_id DESC";
