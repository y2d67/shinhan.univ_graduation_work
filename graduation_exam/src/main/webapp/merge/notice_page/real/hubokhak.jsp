...
<link rel="stylesheet"
	...
	<link type="text/css" rel="stylesheet" href="css/hubokhak.css" />
		...
		<section class="noticepart">
			...
			<section class="sc1">
                ...
                try {
                    ...
                    // 게시물 조회
                    String query = "SELECT post_id, title, author, ctime, tag FROM jdbc_test WHERE tag ='휴복학' ORDER BY post_id DESC";
