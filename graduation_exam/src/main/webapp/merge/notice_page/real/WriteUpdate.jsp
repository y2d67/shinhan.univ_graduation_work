...
<body>
    ...
    <div class="asdf">
        ...
        var tagValue = '<%= tag %>'; // request로 받아온 tag 값
        var grade1Value = '<%= grade1 %>'; // request로 받아온 grade1 값
        var grade2Value = '<%= grade2 %>'; // request로 받아온 grade2 값
        var grade3Value = '<%= grade3 %>'; // request로 받아온 grade3 값
        var grade4Value = '<%= grade4 %>'; // request로 받아온 grade4 값
        var gradeallValue = '<%= gradeall %>'; // request로 받아온 gradeall 값
