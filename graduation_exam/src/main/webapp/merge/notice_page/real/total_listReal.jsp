...
<head>
    <meta charset="UTF-8">
    <title>전체 게시판 페이지</title>
    <link rel="stylesheet" href="http://netdna.bootstrapcdn.com/font-awesome/4.6.2/css/font-awesome.min.css">
    <link type="text/css" rel="stylesheet" href="css/total_listReal.css" />
...
<iframe src="total_list.jsp" width="100%" height="800" frameborder="0"></iframe>
