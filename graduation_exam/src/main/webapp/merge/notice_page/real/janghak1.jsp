...
<link rel="stylesheet"
	...
	<link type="text/css" rel="stylesheet" href="css/janghak1.css" />
		...
		<section class="noticepart">
			...
			<section class="sc1">
                ...
                try {
                    ...
                    // 게시물 조회
                    String query = "SELECT post_id, title, author, ctime, tag FROM jdbc_test WHERE tag ='장학' ORDER BY post_id DESC";
