		...
		<section class="noticepart">
			...
			<section class="sc1">
                ...
                try {
                    ...
                    // 게시물 조회
                    String query = "SELECT post_id, title, author, ctime, gradeall FROM jdbc_test WHERE gradeall = '전체학년' ORDER BY post_id DESC";
